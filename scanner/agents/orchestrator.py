...
from scanner.data.web_research import deep_research
...
def analyze_ticker(ticker: str, verbose: bool = False, skip_research: bool = False) -> dict[str, Any]:
    """
    ...
    # ------------------------------------------------------------------
    # Phase 2.5: Deep Web Research
    # ------------------------------------------------------------------
    research_brief: dict[str, Any] = {}
    raw_research: dict[str, Any] = {}
    if not skip_research:
        console.print("\n[bold]Phase 2.5: Deep Web Research[/bold]")
        raw_research = _step(
            "Scanning web sources (Finviz, MarketWatch, DuckDuckGo, Google Finance)",
            deep_research,
            ticker,
    ...
    data_package = {
        ...
        "options": options,
        "insider_transactions": insider_tx[:10],
