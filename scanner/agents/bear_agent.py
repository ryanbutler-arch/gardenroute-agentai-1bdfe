...
Bear signals found: {research.get('bear_signals_found', [])}
Bull signals found: {research.get('bull_signals_found', [])}  ← acknowledge these as risks to bear case
...
{research_section}
Incorporate the deep research findings, especially verified facts and bear signals.
